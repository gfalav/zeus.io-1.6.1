...
EdesalSchema = new SimpleSchema({
	...
	"cuentaId":                { type: String, label: "Contrato Id", max: 50, optional: true, defaultValue: null },
	"tipoContrato":   		   { type: String, label: "Tipo de Contrato", max: 30, allowedValues: ["SE Edesal","AFR"], defaultValue: "SE Edesal" },
	...
	"potencias.$.potencia":    { type: Number, label: "Potencia Max kW", max: 99999, defaultValue: 2},
	...
	"consumoFijo.$.consumo":   { type: Number, label: "Cons Fijo", max: 99999999, defaultValue: 250 },
	"cosFi.$.nroRecargo":      { type: Number, label: "Ind Cos Fi", max: 3, defaultValue: 0 },
	"cosFi.$.fechaRecargo":    { type: Date, label: "Fecha Recargo", defaultValue: new Date() },
	"cosFi.$.recargo":         { type: Number, label: "Recargo", max: 99999999, defaultValue: 0 },
...
Contratos.attachSchema(EdesalSchema);